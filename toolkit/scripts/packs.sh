...
PACK_ORDER="core database shared-backend backend-micronaut backend-nodejs backend-python frontend-react ux-design infrastructure product ops research"

PACK_DESC_core="Core workflow (always installed)"
PACK_HIDDEN_core=false
PACK_COMING_SOON_core=false
PACK_DEPENDS_core=""
PACK_COMMANDS_core="spec plan build debug onboard daily context-save magic-doc memory-consolidate update pr-ready ship-pr codex devin commit-message commit-message-with-codex ship-pr-codex init-project init-rules scan-rules lint-rules careful freeze unfreeze guard sessions contribute gate-review epic brownfield"
